...
#define MERGE_BUF_PTR(bank, write_offset)		(MERGE_BUF_ADDR+NUM_BANKS*BYTES_PER_PAGE + BYTES_PER_SECTOR * write_offset)
...
#define MERGE_BUF_ADDR		(VCOUNT_ADDR + VCOUNT_BYTES)// merge buffer position
#define MERGE_BUF_BYTES		(((NUM_BANKS * BYTES_PER_PAGE + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR ) * BYTES_PER_SECTOR)
