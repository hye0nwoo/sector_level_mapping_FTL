...
#define CACHE_MAP_BYTES		((NUM_LPAGES * sizeof(UINT32) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)

#define CACHE_LRU_ADDR		(CACHE_MAP_ADDR + CACHE_MAP_BYTES)
#define CACHE_LRU_BYTES		INIT_TABLE_SIZE // init table size
